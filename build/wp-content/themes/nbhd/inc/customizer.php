...
function wp_bootstrap_starter_customize_register($wp_customize)
{
	...
	$wp_customize->add_section(
		'typography',
		array(
			'title' => __('Preset Styles', 'nbhd'),
			//'description' => __( 'This is a section for the typography', 'nbhd' ),
			'priority' => 20,
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'header_bg_color',
			array(
				'label'      => __('Header Banner Background Color', 'nbhd'),
	...
	$wp_customize->add_setting('header_banner_tagline_setting', array(
		'default' => __('To customize the contents of this header banner and other elements of your site go to Dashboard - Appearance - Customize', 'nbhd'),
		'sanitize_callback' => 'wp_filter_nohtml_kses',
	));
	$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'header_banner_tagline_setting', array(
		'label' => __('Banner Tagline', 'nbhd'),
		'section'    => 'header_image',
	...
	$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'header_banner_visibility', array(
		...
		'label'    => __('Remove Header Banner', 'nbhd'),
		'section'    => 'header_image',
		'type'     => 'checkbox',
	)));
	...
	$wp_customize->add_section(
		...
		array(
			'title' => __('Other Customizations', 'nbhd'),
			//'description' => __( 'This is a section for the header banner Image.', 'nbhd' ),
			'priority' => 40,
		)
	);
	$wp_customize->add_section(
		'colors',
		array(
			'title' => __('Background Color', 'nbhd'),
			//'description' => __( 'This is a section for the header banner Image.', 'nbhd' ),
			'priority' => 50,
	...
	$wp_customize->add_section(
		'background_image',
		array(
			'title' => __('Background Image', 'nbhd'),
			//'description' => __( 'This is a section for the header banner Image.', 'nbhd' ),
			'priority' => 60,
			'panel' => 'styling_option_panel',
		)
	...
	$wp_customize->add_control(
		'boostrap_cdn',
		array(
			'label' => __('Use Bootstrap CDN', 'nbhd'),
	...
	$wp_customize->add_control(
		'fontawesome_cdn',
		array(
			'label' => __('Use Fontawesome CDN', 'nbhd'),
			'section' => 'site_name_text_color',
	...
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'wp_bootstrap_starter_logo', array(
		'label'    => __('Upload Logo (replaces text)', 'nbhd'),
