...
function nbhd_scripts()
{
	...
	wp_enqueue_style('nbhd-style', get_template_directory_uri() . '/assets/css/main.min.css?v=2.0.9');
	...
	wp_enqueue_script('nbhd-app', get_template_directory_uri() . '/assets/js/main.min.js', array(), '2.0.0', true);
