...
gulp.task("sass", function () {
  return gulp
    ...
    .pipe(cleanCss())
    .pipe(gulp.dest("dist/css"))
    .pipe(gulp.dest("../build/wp-content/themes/nbhd/assets/css"))
...
gulp.task("js", function () {
  return gulp
    ...
    .pipe(uglify())
    .pipe(gulp.dest("dist/js"))
    .pipe(gulp.dest("../build/wp-content/themes/nbhd/assets/js"));
});
...
gulp.task("image", function () {
  return gulp
    ...
    .pipe(gulp.dest("../build/wp-content/themes/nbhd/assets/img"));
});
...
gulp.task(
  "default",
  gulp.series(gulp.parallel("sass"), gulp.parallel("browsersync", "watch"))
);
